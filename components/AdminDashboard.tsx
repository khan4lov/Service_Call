    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {/* Always online since using real Supabase */}
          <div className="flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold border bg-green-50 border-green-200 text-green-700">
            <Database size={12} />
            ONLINE DB CONNECTED
          </div>
        </div>
        ...
        <div className="flex space-x-2 mb-6 border-b border-slate-200">
          <button 
            ...
            className={`px-4 py-2 font-medium text-sm rounded-t-lg ${
              activeTab === 'BOOKINGS'
                ? 'bg-white border border-b-0 text-accent'
          ...
          >
            <span className="flex items-center gap-2">
              <Briefcase size={16}/> Registrations
            </span>
          </button>
